...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    //UISplitViewController *splitViewController =self.splitViewController; //(UISplitViewController *)self.window.rootViewController;
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "nick.WhereIsMyBucks" in the application's documents directory.
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"WhereIsMyBucks" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"WhereIsMyBucks.sqlite"];
    NSError *error = nil;
...
#pragma mark - Convenience properties methods
////// IPAD ONLY
...
- (BOOL)tabBarController:(UITabBarController *)tbc shouldSelectViewController:(UIViewController *)viewController {
    if (!viewController.tabBarItem.enabled)
        return NO;
    //animated popup? looks like it is never called
...
- (void)setupSplitViews {
    ...
    self.tabBarController = [storyboard instantiateViewControllerWithIdentifier:@"MainTabBar"];
